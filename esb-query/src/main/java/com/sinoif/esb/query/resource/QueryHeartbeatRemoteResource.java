...
import com.sinoif.esb.query.remote.QueryHeartbeatRemoteService;
...
/**
 * @author 袁毅雄
 * @description 远程接口实现-ESB query 心跳服务
 * @date 2019/11/1
 */
public class QueryHeartbeatRemoteResource implements QueryHeartbeatRemoteService {
